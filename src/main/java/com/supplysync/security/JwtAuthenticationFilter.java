...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            try {
                Boolean hasKey = redisTemplate.hasKey("blacklist:" + jwt);
                isBlacklisted = (hasKey != null && hasKey);
            } catch (Exception e) {
                log.warn("Redis is not available for checking token blacklist: {}", e.getMessage());
            }
